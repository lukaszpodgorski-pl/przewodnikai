---
title: "Ścieżka: Rodzic"
description: "Ścieżka nauki AI dla rodziców - jak mądrze towarzyszyć dziecku w świecie AI."
sidebar:
  hidden: true
---
...
Zrozum AI, żeby mądrze towarzyszyć dziecku, gdy z niej korzysta. Wybrałem 6 lekcji przy takim założeniu, że nie musisz zostać ekspertem - wystarczy wiedzieć na tyle dużo, żeby rozmowa w domu była rozmową, a nie zakazem.
...
O dolnej granicy wieku w narzędziach AI i o zgodzie rodzica piszę w ramce w [ścieżce dla ucznia szkoły podstawowej](/sciezki/uczen-podstawowka/) - warto przejść ją razem z dzieckiem.
