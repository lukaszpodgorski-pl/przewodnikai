...
**Przykład:** Aby nauczyć system rozpoznawania kotów na zdjęciach, dostarczamy mu tysiące obrazów oznaczonych jako „kot" i „nie kot". Te oznaczone obrazy stanowią dane treningowe.
...
**Przykład:** Trening dużego modelu językowego, takiego jak GPT-4, wymaga tysięcy wysoko wydajnych GPU pracujących równolegle przez wiele tygodni, co kosztuje miliony dolarów w zasobach obliczeniowych.
...
:::tip[Wskazówka]
Wracaj do tego słownika za każdym razem, gdy natkniesz się na nieznany termin w kursie lub w artykule o AI. Możesz też użyć skrótu Ctrl+F, żeby szybko wyszukać interesujące Cię pojęcie na tej stronie.
:::
