...
<!-- TODO(Łukasz): tu zadziałałaby anegdota - które konkretnie pojęcie najdłużej Ci się nie układało w całość, gdy sam uczyłeś się AI? -->
...
| **2. Jak to działa** (10 lekcji) | AI/ML/Sieci → Jak uczą się modele → Typy AI → LLM → Tokeny → Embedding → Parametry → Dane → Boom AI → Mapa AI | Rozumiesz mechanizmy - dlaczego AI "halucynuje", skąd się biorą odpowiedzi |
| **3. Prompt Engineering** (9 lekcji) | Wprowadzenie → Podstawy → Techniki → Rozumowanie → Schematy → Automatyzacja → Programowanie → Najlepsze praktyki → Baza promptów | Piszesz skuteczne prompty, stosujesz zaawansowane techniki |
| **4. Narzędzia** (5 lekcji) | Chatboty → Generatory obrazów → Pisanie → Specjalistyczne → AI w codziennej pracy | Znasz ekosystem narzędzi AI i dobierasz je do zadania |
...
Zanim przejdziesz dalej, chcę, żebyś dotknął AI w praktyce. Skopiuj poniższy prompt i wklej go do [ChatGPT](https://chat.openai.com), [Claude](https://claude.ai) lub innego chatbota AI:
...
<!-- TODO(Łukasz): tu zadziałałaby anegdota - jaki był pierwszy prompt, który realnie oszczędził Ci czas w pracy, i ile go zaoszczędził? -->
