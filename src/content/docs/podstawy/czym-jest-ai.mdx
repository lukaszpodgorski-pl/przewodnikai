...
faq:
  ...
  - q: Gdzie spotykamy AI na co dzień?
    a: 'AI jest wszędzie: w asystentach głosowych (Siri, Gemini), rekomendacjach filmów i produktów, tłumaczeniach automatycznych, filtrach antyspamowych, nawigacji GPS i wielu innych aplikacjach.'
---

import Termin from '../../../components/Termin.astro';
import SlowniczekStrony from '../../../components/SlowniczekStrony.astro';

![Świetlisty mózg-obwód w kształcie znaku zapytania obok zaciekawionej postaci - czym jest sztuczna inteligencja](../../../assets/podstawy/czym-jest-ai/czym-jest-ai.jpg)
...
- **Smartfony i asystenci głosowi:** Gdy pytasz o pogodę Siri albo Gemini (który na telefonach z Androidem [zastępuje Asystenta Google](https://blog.google/products-and-platforms/products/gemini/google-assistant-gemini-mobile/)), to AI stara się zrozumieć Twoje pytanie i znaleźć odpowiedź. Podobnie działa funkcja autokorekty tekstu - telefon domyśla się, co chciałeś napisać.
...
Kolejne rozdziały poprowadzą Cię krok po kroku - od tego, jak zaplanować naukę, po pierwszą rozmowę z <Termin id="chatbot">chatbotem</Termin>. Idziemy spokojnie, bez strachu i bez nadęcia.

Na koniec szczera historia. Pierwsza rzecz, jaką wygenerował mi chatbot, była kompletną bzdurą. Wielu ludzi w tym momencie macha ręką - "głupie, do niczego się nie nadaje" - i odpuszcza. To błąd z dwóch powodów. Po pierwsze, te narzędzia zmieniają się z miesiąca na miesiąc, a modele pod nimi odpowiadają dziś na zupełnie innym poziomie niż rok czy dwa lata temu - i wciąż idą w górę. Po drugie, jakość odpowiedzi zależy w ogromnym stopniu od jakości pytania: w branży mówi się "garbage in, garbage out" - śmieci na wejściu, śmieci na wyjściu. I dobra wiadomość - akurat tego można się nauczyć; poświęcimy temu sporą część kursu, [sekcję o prompt engineeringu](/prompt-engineering/).

## Źródła i dalsze lektury

- [Stanford HAI AI Index Report](https://hai.stanford.edu/research/ai-index-report) - kompleksowy, corocznie aktualizowany raport o stanie sztucznej inteligencji, adopcji w biznesie i zastosowaniach
...
<SlowniczekStrony terminy={["genai", "chatbot"]} />
