---
title: Czym jest AI?
description: Kompleksowy kurs sztucznej inteligencji od podstaw. Poznaj podstawowe pojęcia i koncepcje AI.
sidebar:
  order: 2
...
mentions:
  ...
  - name: Siri
    sameAs: https://en.wikipedia.org/wiki/Siri
    type: SoftwareApplication
  - name: Netflix
    sameAs: https://en.wikipedia.org/wiki/Netflix
    type: Organization
faq:
  - q: Czym jest sztuczna inteligencja?
    a: Sztuczna inteligencja (AI) to dziedzina informatyki zajmująca się tworzeniem programów, które potrafią wykonywać zadania wymagające ludzkiej inteligencji - rozpoznawać wzorce, podejmować decyzje i uczyć się na podstawie danych.
  - q: Czym różni się AI od generatywnej AI?
    a: 'AI to szerokie pojęcie obejmujące wszystkie systemy naśladujące ludzką inteligencję. Generatywna AI (GenAI) to jej podzbiór - systemy potrafiące tworzyć nowe treści: teksty, obrazy, muzykę czy kod.'
  - q: Gdzie spotykamy AI na co dzień?
    a: 'AI jest wszędzie: w asystentach głosowych (Siri, Google Assistant), rekomendacjach filmów i produktów, tłumaczeniach automatycznych, filtrach antyspamowych, nawigacji GPS i wielu innych aplikacjach.'
---

## Czym jest sztuczna inteligencja?

![Wizualizacja czym jest sztuczna inteligencja](../../../assets/podstawy/czym-jest-ai/czym-jest-ai.jpg)

Sztuczna inteligencja brzmi poważnie i futurystycznie. Pewnie kojarzy Ci się z filmami sci-fi albo supermądrymi robotami. A tymczasem z AI spotykasz się na co dzień, nawet jeśli nie zdajesz sobie z tego sprawy. To trochę jak z elektrycznością: nie musisz rozumieć wszystkich szczegółów, żeby korzystać z jej dobrodziejstw. Zanim wejdziemy głębiej, wyjaśnię Ci, czym AI właściwie jest i dlaczego ostatnio wszędzie o niej głośno.
