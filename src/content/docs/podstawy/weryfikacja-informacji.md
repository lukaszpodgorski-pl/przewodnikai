...
description: Poznaj praktyczne metody weryfikacji informacji przekazywanych przez sztuczną inteligencję oraz naucz się rozpoznawać halucynacje AI. Dowiedz się, kiedy i jak sprawdzać wiarygodność treści generowanych przez modele AI.
sidebar:
  order: 8
educationalLevel: Beginner
teaches:
  - Jak weryfikować informacje od AI
  - Sprawdzanie faktów generowanych przez AI
  - Krytyczna ocena odpowiedzi AI
about:
  - name: Fact-checking
    sameAs: https://en.wikipedia.org/wiki/Fact-checking
  - name: Sztuczna inteligencja
    sameAs: https://pl.wikipedia.org/wiki/Sztuczna_inteligencja
faq:
  - q: Jak sprawdzić czy AI mówi prawdę?
...
:::caution[Pamiętaj]
AI często podaje Ci nieprawdziwe informacje z dużą pewnością siebie, bez żadnych sygnałów ostrzegawczych. Nawet jeśli odpowiedź brzmi przekonująco i profesjonalnie, nie oznacza to, że jest prawdziwa!
:::
...
**"AI Slop"** - termin roku 2025 według słownika Macquarie Dictionary (z kolei Merriam-Webster wybrał słowo "slop") - oznacza masowo produkowaną treść niskiej jakości generowaną przez AI z minimalnym lub zerowym nadzorem ludzkim. To zjawisko stanowi rosnące zagrożenie dla jakości informacji w internecie.

:::danger[Realny przypadek: Huragan Helene (2024)]
Podczas huraganu Helene we wrześniu 2024 roku, AI slop zdominował wyniki wyszukiwania dotyczące schronień awaryjnych i pomocy humanitarnej. Ludzie szukający krytycznych informacji o ewakuacji trafiali na automatycznie generowane artykuły z nieprawdziwymi lub nieaktualnymi danymi. W sytuacji zagrożenia życia, AI slop może być dosłownie śmiertelnie niebezpieczny.
:::
...
Zwracaj szczególną uwagę na te typy "halucynacji":

- **Wymyślone źródła** - nieistniejące artykuły naukowe, książki, badania czy autorzy, które AI może przedstawiać jako wiarygodne
- **Fałszywe dane kontaktowe** - fikcyjne strony internetowe, numery telefonów czy adresy e-mail, które w rzeczywistości nie istnieją
...
Metoda **SIFT** to uznany framework weryfikacji informacji, opracowany przez Mike'a Caulfielda z Washington State University Vancouver. W erze AI, gdzie halucynacje brzmią tak samo przekonująco jak fakty, chcę, żeby SIFT stał się Twoją standardową procedurą:

:::note[S - Stop - Zatrzymaj się]
...
:::tip[I - Investigate the source - Zbadaj źródło]
...
:::caution[F - Find better coverage - Znajdź lepsze źródła]
...
:::note[T - Trace claims - Prześledź twierdzenie]
...
AI podaje: _"Według raportu McKinsey z 2024 roku, 78% polskich firm planuje wdrożenie AI w ciągu 2 lat."_

1. **S (Stop)** - Liczba 78% brzmi bardzo konkretnie i wysoko. Czerwona flaga.
2. **I (Investigate)** - Szukam raportu McKinsey 2024 o AI w Polsce. Nie znajduję takiego dokumentu.
3. **F (Find)** - Szukam innych źródeł o adopcji AI w Polsce. Znajduję dane GUS i PwC z innymi liczbami.
4. **T (Trace)** - McKinsey publikował raporty o AI, ale nie z takimi danymi dla Polski.
5. **Wniosek:** Informacja jest halucynacją - AI "wymyśliło" raport.

<!-- TODO(Łukasz): tu zadziałałaby anegdota - czy zdarzyło Ci się przepuścić dalej wymyśloną przez AI liczbę albo źródło i wyłapać to dopiero później? -->
...
Do weryfikacji przydadzą Ci się te narzędzia:
...
Są tematy, przy których weryfikacja to nie opcja:
...
- [ ] Sprawdziłem w minimum 3 niezależnych źródłach
...
AI jest narzędziem, które ma Ci pomóc - nie zastąpić Twoje krytyczne myślenie. Ostateczna odpowiedzialność za weryfikację informacji i podejmowanie decyzji zawsze spoczywa na Tobie.
:::
