...
| --- | --- | --- |
| **ChatGPT** | [chatgpt.com](https://chatgpt.com) | Wszechstronny - rozmowa (także głosowa), generowanie obrazów, praca z plikami |
| **Claude** | [claude.ai](https://claude.ai) | Świetna jakość dłuższych tekstów i analizy dokumentów; nie generuje obrazów |
| **Gemini** | [gemini.google.com](https://gemini.google.com) | Równie wszechstronny, a do tego spięty z Gmailem, Dyskiem i Dokumentami Google |
...
Zacznij od [ChatGPT](https://chatgpt.com) lub [Gemini](https://gemini.google.com) - oba łączą w jednym miejscu rozmowę (także głosową), generowanie obrazów i pracę z plikami, więc najszybciej pokażą Ci pełen przekrój tego, co AI potrafi. Jeśli na co dzień korzystasz z Gmaila i Dysku Google, Gemini ma dodatkowy atut: potrafi zajrzeć do Twojej poczty i dokumentów. Claude'a wypróbuj z czasem - nie generuje obrazów, za to jakością pisania i analizy dokumentów potrafi pozytywnie zaskoczyć.
:::

Sam zaczynałem od ChatGPT - i jeszcze niedawno polecałbym Ci dokładnie to samo, bo przez długi czas to on stawiał przed początkującymi najmniejszy opór: wchodzisz, piszesz, działa. Ale ten rynek szybko się wyrównuje i dziś większość dużych dostawców oferuje bardzo podobny zestaw możliwości. Dlatego ważniejsze od szukania "jedynego słusznego" narzędzia jest to, żebyś po prostu zaczął - od tego, które masz najbliżej pod ręką.
...
Jest w tym jednak pułapka: długa instrukcja to nie to samo co dobra instrukcja. Dotyczy to w równym stopniu rozmowy z drugą osobą i pracy z modelem językowym. W obszernych poleceniach zwykle znajduje się mnóstwo balastu - słów, które nie wpływają na jakość otrzymanej odpowiedzi. Decyduje dokładność tego, co chcesz przekazać, a nie objętość tekstu, jak wiele osób błędnie zakłada.

Nie pamiętam już, o co pytałem w swoim pierwszym prompcie - to było zbyt dawno temu. Za to doskonale pamiętam, jak wyglądały odpowiedzi: model potrafił w jednym akapicie przeskoczyć z formy męskiej na żeńską, a między polskie zdania wplatał angielskie słowa. Dzisiejsze modele radzą sobie z polszczyzną nieporównanie lepiej, ale wniosek z tamtych czasów mam wciąż ten sam: słaba odpowiedź to nie powód, żeby się zniechęcać - to sygnał, żeby doprecyzować prompt albo po prostu spróbować jeszcze raz.
