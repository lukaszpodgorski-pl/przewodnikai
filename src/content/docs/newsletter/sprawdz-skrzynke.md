...
description: Wysłałem Ci wiadomość z linkiem potwierdzającym zapis na powiadomienia o nowych materiałach w Przewodniku AI.
template: splash
noindex: true
pagefind: false
sidebar:
...
Dzięki temu mam pewność, że to naprawdę Ty, a nie ktoś, kto wpisał Twój adres bez Twojej wiedzy. To ta sama zasada, o której piszę w rozdziale o [prywatności i danych](/etyka/prywatnosc/) - nie chcę robić nikomu tego, przed czym sam ostrzegam.

W międzyczasie możesz [wrócić do kursu](/podstawy/wstep/) albo [przejrzeć program](/).
