...
Jednym z kluczowych odkryć było to, że modele językowe stają się lepsze w przewidywalny sposób, gdy zwiększamy liczbę parametrów (rozmiar modelu), ilość danych treningowych oraz moc obliczeniową treningu.
