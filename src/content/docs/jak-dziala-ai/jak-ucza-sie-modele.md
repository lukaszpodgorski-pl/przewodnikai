...
1. Model dostaje dane wejściowe (np. zdjęcia) + etykiety (np. "kot" / "pies")
...
1. Model dostaje dane bez etykiet
...
<!-- TODO(Łukasz): tu zadziałałaby anegdota - kiedy widziałeś, jak zła jakość danych wejściowych zepsuła wynik modelu? -->
